...
import { useGuideReviews, useReplyToReview } from '../../src/api/queries/reviews';
import {
  ErrorView,
  LoadingView,
  ScreenContainer,
...
export default function GuideReviewsScreen() {
  const { data, isLoading, isError, error: errorMsg, refetch } = useGuideReviews();
    ...
    <ScreenContainer scroll={false} style={{ padding: 0 }}>
      ...
      {reviews.length === 0 ? (
        <View style={styles.emptyContainer}>
          ...
          <Text style={styles.emptySubtext}>Reviews from your guests will appear here</Text>
        </View>
      ) : (
